# <span style="color:red;">Data Deletion</span>
...
You can get rid of your data in the following ways:

### 1. Revoke access:
Take away access through your Google account  You can take away access from the connected app in your [Google Account Settings](https://myaccount.google.com/permissions).  Within 24 hours, your data that we have on file will be deleted from our system.
...
### 3. Leaving the Discord Server:
Within 24 hours of leaving the Dreamer's Land Discord server, all of your data will be automatically erased. (<span style="color:red;">this method is not recommended.</span>)

---

> Final Note: You have complete control over your data at all times.You can use the above options to delete it whenever you want.
